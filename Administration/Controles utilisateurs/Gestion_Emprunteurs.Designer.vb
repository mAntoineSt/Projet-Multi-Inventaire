...
Partial Class Gestion_Emprunteurs
    ...
    Private Sub InitializeComponent()
        ...
        Me.bSuppressionAdmin.TabIndex = 11
        ...
        Me.dgvListeAdministrateurs.TabIndex = 7
        '
        'Gestion_Emprunteurs
        '
